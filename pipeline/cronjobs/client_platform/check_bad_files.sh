...
scp $CRONDIR/../detection/bad_files.json $HPC_USER@$HPC_PLATFORM:~/src/linefinder/current_bad_files.json
...
scp $HPC_USER@$HPC_PLATFORM:~/src/linefinder/bad_files.json $CRONDIR/../detection/
