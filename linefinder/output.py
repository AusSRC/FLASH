...
def initialize_resultsfile(options,model,suffix="",name=None):

    # Set path to results file
    if name:
        results_file = name
    else:
        results_file = options.out_path + ('/results%s.dat'%suffix)
...
def write_resultsfile(options,source,model,suffix="",name=None):
