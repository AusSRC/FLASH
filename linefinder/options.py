...
parser.add_argument('--sourcelog', default='/config/sources.log', type=str,
                    help='name of sources log in config directory')
...
parser.add_argument('--model_path', default='/config/model.txt', type=str,
